...
// --- Page Data ---
// Data based on official Schengen/Czech Republic requirements for Pakistan.
...
const embassyInfo = {
  title: "Embassy of the Czech Republic, Islamabad",
  address: "House 49, Street 27, Sector F-6/2, Islamabad",
  phone: "+92 (0)51 227 68 49",
  email: "islamabad@mzv.gov.cz",
  note: "All visa applications are submitted through VFS Global, not the embassy directly."
};

const vfsInfo = {
  title: "Czech Republic Visa Application Centre (VFS Global)",
  address: "Park Road, Chak Shahzad, (Opposite CDA Park), Islamabad",
  phone: "0900 07860 (VFS Helpline)",
  email: "info.czechrepublicpk@vfshelpline.com",
  note: "This is the official partner for submitting your application and biometrics."
};

// --- Czech Republic-Specific FAQs ---
const faqs = [
  {
    q: "Is the Czech Republic a Schengen country?",
    a: "Yes, the Czech Republic is a full member of the Schengen Area. A visa for the Czech Republic is a Schengen visa, allowing you to travel to all 29 member countries."
  },
  {
    q: "Can I apply for a Czech e-visa?",
  ...
  {
    q: "How long does the Czech visa take?",
...
// --- Czech Republic/Schengen-Specific Reviews ---
const reviews = [
  {
    name: "Hammad K.",
    quote: "O.S. Travel is the best for Schengen visas. They prepared my entire file for my Czech Republic (Prague) trip. I was so worried, but they handled everything. Got my visa!",
    rating: 5
  },
  {
    name: "S. Khurram",
    quote: "I highly recommend their file processing service for my Prague trip. They arranged my appointment and all my bookings. I just had to show up at VFS. Very professional.",
    rating: 5
  },
  {
    name: "The Awan Family",
    quote: "We used O.S. Travel for our family vacation to the Czech Republic. They processed all our applications. The file was perfect, and the visa was approved. Thank you!",
    rating: 5
  }
];
...
// --- Main Component ---
function CzechRepublic() { // Corrected function name
  return (
    <motion.div
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex items-center gap-4 mb-8">
        <img
          src="https://flagcdn.com/w160/cz.png" // Czech Republic flag
      ...
      >
        <h2 className="text-3xl font-bold text-gray-800 mb-6 text-center">
          Why Choose O.S. Travel for Your <span className="text-blue-600">Czech Visa</span>?
        </h2>
      ...
      <motion.div variants={itemVariants} className="text-center mt-10 text-sm text-gray-500">
        <p>Visa approval is at the sole discretion of the Embassy of the Czech Republic. O.S. Travel & Tours provides expert file preparation services.</p>
      </motion.div>
...
export default CzechRepublic; // Corrected export