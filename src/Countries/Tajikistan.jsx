...
const eVisa = {
  title: "E-Visa (Not available for Pakistani Citizens)",
  subtitle: "Online Portal",
  totalFee: "$160 (Approx.)", // Fee taken from sticker visa
  ...
  return (
    ...
    >
      ...
      >
        <button
          onClick={() => {
            sessionStorage.setItem('selected_visa_country', 'tajikistan');
